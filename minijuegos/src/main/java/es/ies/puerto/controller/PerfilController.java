...
public class PerfilController extends AbstractController {
    ...
    @FXML
    protected void jugar2() {
        try {
            FXMLLoader loader = new FXMLLoader(PrincipalApplication.class.getResource("tictactoe.fxml"));
            Parent root = loader.load();

            TicTacToeController ticTacToeController = loader.getController();
            ticTacToeController.setPropertiesIdioma(this.getPropertiesIdioma());
